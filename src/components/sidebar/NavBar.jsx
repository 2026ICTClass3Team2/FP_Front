      ...
      <nav className="flex-1 overflow-y-auto scrollbar-hide p-3 space-y-1">
        ...
        >
          <svg
            ...
            strokeWidth="2.5"
          >
            <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2 2 2 0 01-2-2 2 2 0 012-2 2 2 0 01-2-2z" />
          </svg>
          <span>질문답변 게시판</span>
        </Link>
        ...
        <div className="px-4 pt-6">
          <button className="btn-primary w-full py-3 text-sm font-black flex items-center justify-center gap-2">
            채널 만들기
          </button>
        </div>
      </nav>
