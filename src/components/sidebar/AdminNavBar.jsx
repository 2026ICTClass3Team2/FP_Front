  ...
  return (
    <aside className="w-64 border-r border-border flex flex-col h-full bg-background shrink-0 select-none">
      ...
      <nav className="flex-1 overflow-y-auto scrollbar-hide p-3 space-y-1">
        ...
        {/* 관리자 대시보드 */}
        <Link to="/admin" className="w-full flex items-center gap-3 px-4 py-3 rounded-xl font-semibold text-red-500 bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/30 transition-all border border-red-200 dark:border-red-800">
