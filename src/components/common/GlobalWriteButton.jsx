  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 flex flex-col bg-surface border border-border rounded-2xl shadow-xl overflow-hidden z-50 min-w-[180px]">
          <button
            ...
            className="flex items-center gap-3 px-5 py-3.5 text-sm font-semibold text-foreground hover:bg-secondary transition-colors border-b border-border cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-3 px-5 py-3.5 text-sm font-semibold text-foreground hover:bg-secondary transition-colors cursor-pointer"
          >
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 w-14 h-14 bg-primary text-primary-foreground rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center z-50 cursor-pointer ${isOpen ? 'rotate-45 hover:bg-primary/90' : 'hover:-translate-y-1'}`}
      >
